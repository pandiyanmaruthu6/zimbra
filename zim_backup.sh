...
EMAILFROM="admin@sender.com"
EMAILTO="support@recepient.in"

# Email account NOT to backup
EXCEPTIONS="galsync.afzwy4t6@sender.com;ham.lxtbjuoeq@sender.com;spam.pfhjmpwu@sender.com;virus-quarantine.rbjdvfur4q@sender.com"
...
/opt/zimbra/postfix/sbin/sendmail -t "Backup Completed" "support@recepient.in"<$LOGFILE
